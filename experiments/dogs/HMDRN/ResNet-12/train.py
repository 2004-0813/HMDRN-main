...
sys.path.append('../../../../')
from trainers import trainer, hmdrn_train
from datasets import dataloaders
from models.HMDRN import HMDRN
...
model = HMDRN(way=train_way,
              shots=[args.train_shot, args.train_query_shot],
              resnet=args.resnet)

train_func = partial(hmdrn_train.default_train,train_loader=train_loader)
